globals [
  ...
  government_tax_income
  global_metabolism
  global_sugar_growback
  gini-index-reserve
  lorenz-points
]
...
to setup
  ...
  set government_expenditure 0
  set government_tax_income 0
  reset-ticks
end
...
to go
  ...
  ask patches [
    patch-growback
    patch-recolor
    set global_sugar_growback sum [max-psugar] of patches
  ]
  ask turtles [
    turtle-move
    turtle-eat
    if sugar <= 0
      [ die ]
    run visualization
    set global_metabolism sum [metabolism] of turtles
  ]
  update-lorenz-and-gini
  tick
end
...
to turtle-eat ;; turtle procedure
  ...
  [
    ifelse sugar < 10
    [
      set government_expenditure (government_expenditure + redistribution)
      set sugar (sugar - metabolism + psugar + redistribution)
      set psugar 0
    ]
    [
  ...
  [
        set government_tax_income (government_tax_income + psugar * tax_rate)
        set sugar (sugar - metabolism + psugar * (1 - tax_rate))
        set psugar 0
  ]
...
545
government_sugar
government_tax_income - government_expenditure
2
1
11
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot government_tax_income - government_expenditure"
...
@#$#@#$#@
<experiments>
  <experiment name="survival_rate" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="200"/>
    ...
    <enumeratedValueSet variable="tax_rate">
      <value value="0"/>
      <value value="0.2"/>
      <value value="0.4"/>
      <value value="0.6"/>
  ...
  <experiment name="government_finance" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="200"/>
    <metric>government_tax_income - government_expenditure</metric>
    <enumeratedValueSet variable="initial-population">
      <value value="400"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="redistribution">
  ...
  <experiment name="gini" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="200"/>
